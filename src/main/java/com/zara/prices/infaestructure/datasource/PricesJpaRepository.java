...
public interface PricesJpaRepository extends JpaRepository<PricesEntity, Long> {
    List<PricesEntity> findByEndDateGreaterThanEqualAndStartDateLessThanEqualAndProductIdAndBrandId(LocalDateTime startDate, LocalDateTime endDate, Integer productId, Long brandId);
